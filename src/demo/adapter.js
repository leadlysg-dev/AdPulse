...
import { buildReport, buildManageTree, buildHeatmap, buildStatus, buildMetricsConfig, buildAccounts, buildChips, chatFallback } from './derive';
...
export async function demoRequest(path, options = {}, passthrough) {
  ...
  if (fn === 'pulse-chat') {
    ...
    try {
      ...
      return { reply: chatFallback(payload.chip), actions: [] };
    }
  }
