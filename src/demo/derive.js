...
export function chatFallback(chip) {
  ...
  if (chip === 'spend') {
    return `You spent **S$${spend.toLocaleString()}** in the last week — split roughly between Meta and Google, with **${best ? best.name : 'your top campaign'}** using its share most efficiently.`;
  }
  return 'This demo answers the suggested questions below with sample data — ask Pulse anything about the numbers on screen.';
}
