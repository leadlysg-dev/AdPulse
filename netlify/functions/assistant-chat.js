...
const SYSTEM_PROMPT = `You are the assistant inside Leadly, a self-serve ad reporting dashboard for small-business owners. Your job is to help users set up performance alerts in plain English.
